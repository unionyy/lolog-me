...
module.exports.Gen = function(_gameData) {
    ...
    _gameData.forEach(game => {
        ...
        html +=
        `<a class="user-games-game" href="https://your.gg/kr/profile/test/match/${game.game_id}" target="_blank" rel="noopener noreferrer" timestamp="${timestamp}" gametype="${QUEUETYPE[game.queue_type]}">
