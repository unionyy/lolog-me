    ...
    return `<div id="user-profile">
                ...
                <div id="user-ranks">
                    <div class="profile-rank">
                        ...
                        <div class="profile-rank-text">
                            <div class="profile-rank-text-grid">
                                <span class="gg-sub-title">${__('ranked_solo')}</span>
                                <span class="text-${_userData.solo_tier} mt-1">${_userData.solo_tier} ${_userData.solo_rank}</span>
                    ...
                    <div class="profile-rank">
                        ...
                        <div class="profile-rank-text">
                            <div class="profile-rank-text-grid">
                                <span class="gg-sub-title">${__('ranked_flex')}</span>
                                <span class="text-${_userData.flex_tier} mt-1">${_userData.flex_tier} ${_userData.flex_rank}</span>
