const ICONURI = 'https://ddragon.leagueoflegends.com/cdn/11.3.1/img/profileicon/';
    ...
    return `<div id="user-profile">
                <div id="user-profile-bio">
                    <div id="user-profile-bio-img">
                        <img src="${ICONURI + _userData.profile_icon_id}.png">
                    </div>
                    <div id="user-profile-bio-grid">
                        ...
                        <form id="user-profile-refresh" action="/update" method="post">
                            ...
                            <input id="update-button" value="${__('update')}" type="submit">
                        </form>
                    </div>
                </div>
                <div id="user-ranks">
