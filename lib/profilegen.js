                    ...
                    <div class="profile-rank">
                        ...
                        <div class="profile-rank-text">
                            <div class="profile-rank-text-grid">
                                ...
                                <span class="mt-1">${(_userData.solo_wins * 100/(_userData.solo_wins + _userData.solo_losses)).toFixed(2)}% ${_userData.solo_lp}lp</span>
                                <span>
                    ...
                    <div class="profile-rank">
                        ...
                        <div class="profile-rank-text">
                            <div class="profile-rank-text-grid">
                                ...
                                <span class="mt-1">${(_userData.flex_wins * 100/(_userData.flex_wins + _userData.flex_losses)).toFixed(2)}% ${_userData.flex_lp}lp</span>
                                <span>
