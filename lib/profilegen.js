const { RIOTCDNURI, PLATFORMS } = require("./constant");
    ...
    return `<div id="user-profile" class="in-box">
                <div id="user-profile-bio">
                    ...
                    <div id="user-profile-bio-grid">
                        <h1 id="user-profile-name" accountId="${_userData.account_id}">${_userData.summoner_name}</h1>
                        <form id="user-profile-refresh" action="/update" method="get">
                            <input id="user-name" type="hidden" name="username" value="${_userData.norm_name}">
                            <input id="user-platform" type="hidden" name="platform" value="${PLATFORMS[_userData.platform_my]}">
                ...
                <div id="user-ranks">
                    <div class="profile-rank">
                        <img src="/images/icon/${_userData.solo_tier}.png" alt="${_userData.solo_tier}">
                    ...
                    <div class="profile-rank">
                        <img src="/images/icon/${_userData.flex_tier}.png" alt="${_userData.flex_tier}">
                        <div class="profile-rank-text">
                            <div class="profile-rank-text-grid">
