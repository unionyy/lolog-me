...
function HTMLtoolbar(__, _selectePlatform) {
    return`
                <div id="toolbar">
                    <a href="/"><img id="title-logo" src="/images/logo.png" href="/"></a>
...
module.exports = {
    HTMLindex: function (__, _selectePlatform) {
        ...
        <html>
            ...
            <div id="wrapper">
                ...
                <div id="title-main">
                    <h1 id="title-title"><a href="/"><img id="title-logo" src="/images/logo.png" href="/"></a></h1>
    ...
    HTMLuser: function(_data, __, _selectePlatform, _begin, _end, _offset) {
        ...
        var graphHtml = graphGen.Gen(__, _begin, _end, _offset);
