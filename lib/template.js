...
function HTMLheads(_title, _description, _keywords, _url) {
    return `
        ...
        <link rel="icon" href="/images/favicon/icon.svg">
        <link rel="mask-icon" href="/images/favicon/icon.svg" color="#38b259">
...
<html lang="${__('lang_value')}">
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="title-main">
                <div id="title-title">
                    <a href="/"><img id="title-logo" src="/images/logo.svg" alt="LoLog.me"></a>
                </div>
                ${HTMLsearchbox(__, _selectePlatform)}
            </div>
