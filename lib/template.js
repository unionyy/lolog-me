...
function HTMLsearchbox(__, _selectePlatform) {
    ...
    return `
                    <form id="searchbox" action="/search" method="get">
                        ...
                        <input id="searchbox-box" type="text" name="username" placeholder="${__('input_summoner')}" autocomplete="off" required="true" />
                        
                        <button id="searchbox-button"><i class="fa fa-search" aria-hidden="true"></i></button>
                        
                        <div id="recent-users"><div id="recent-container"></div></div>
                    </form>
                    `;
