...
module.exports = {
            ...
            <body>
                <div id="title-main">
                    ...
                    <form id="title-search" action="/search" method="post">
                        <input id="title-search-box" type="text" name="username" placeholder="${__('input_summoner')}">
                        <input id="title-search-button" value="${__('search')}" type="submit">
                    </form>
                </div>
            </body>
        </html>
            ...
            <body>
                <div id="user-main">
                    ...
                    <form id="user-search" action="/search" method="post">
                        <input id="user-search-box" type="text" name="username" placeholder="${__('input_summoner')}">
                        <input id="user-search-button" value="${__('search')}" type="submit">
                    </form>
                </div>
    ...
    HTMLnouser: function(userName, __) {
        return`
        <!DOCTYPE html>
        <html>
            ...
            <body>
                ...
                <h2 class="no-user">"${userName}" ${__('user_not_found')}</h2>
            </body>
        </html>
        `
    }
