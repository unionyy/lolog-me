...
module.exports = {
    ...
    HTMLuser: function(_data, total, start, end, datehtml, data) {
        // total, start, end, profilehtml, datehtml
        var profileHtml = profileGen.Gen(_data.userData);
        var graphData = graphGen.Gen(_data.gameData);
        return`
        <!DOCTYPE html>
        <html>
            <head>
                ...
                <div id="user-content">
                    ...
                    <div id="user-graph">
                        <div id="user-graph-header">
                            <div>
                                <span id="username-total">${graphData.total}판</span><span id="username-period"> (${graphData.start}~${graphData.end})</span></div>
                            <div></div>
