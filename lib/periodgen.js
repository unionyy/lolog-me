    ...
    return `
        <div id="period">
            <div id="seasons">
                ...
                <div class="seasons-button">
                    <a class="seasons-link" href="/${PLATFORMS[_userData.platform_my]}/user/${_userData.norm_name}">1 Year</a>
                </div>
                <div class="seasons-button">
                    <a class="seasons-link" href="/${PLATFORMS[_userData.platform_my]}/user/${_userData.norm_name}?end=${min}">2 Year</a>
                </div>
            </div>
            <div></div>
