    ...
    if(userData) {
        ...
        if(apiUserData) {
            ...
            if(userDataPuuid) {
                ...
                var rev = await SearchGamesAPI(newUserData.account_id, _platform, newUserData.explore_idx, new Date(new Date() - 31536000000), newUserData.id_my);
    ...
    if(userData) {
        ...
        if(apiUserData) {
            if(userData.puuid === apiUserData.puuid) {
                ...
                // Get New Game Data
                var rev0 = SearchGamesAPI(apiUserData.account_id, _platform, 0, new Date(userData.update_time * 1000), userData.id_my);
                ...
                if(userDataPuuid) {
                    ...
                    // Get New Game Data
                    var rev0 = await SearchGamesAPI(apiUserData.account_id, _platform, 0, new Date(userDataPuuid.update_time * 1000), userDataPuuid.id_my);
