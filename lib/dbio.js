...
module.exports.GetSummonerName = function (_normName, _platform, _cols = '*') {
    return new Promise((resolve, reject,) => {
        db.query(
...
module.exports.GetSummonerPUUID = function (_puuid) {
    return new Promise((resolve, reject,) => {
        db.query(
...
module.exports.InputSummoner = function (_data) {
    return new Promise((resolve, reject,) => {
        db.query(
            `INSERT INTO users (norm_name, platform_my, update_time, account_id, summoner_id, puuid, real_name, profile_icon_id, summoner_level, solo_tier, solo_rank, solo_lp, solo_wins, solo_losses, flex_tier, flex_rank, flex_lp, flex_wins, flex_losses) 
            VALUES(?, ?, NOW(), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
