module.exports.Gen = function (__, _begin, _end) {
    ...
    <div id="user-graph-svg" class="in-box">
    <svg class="graph-svg">
  ...
  </svg></div><div id="charts"><div id="charts-lane"></div><div id="charts-champ"></div></div></div>`;
